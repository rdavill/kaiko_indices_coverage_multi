...
def get_indices_data():
    """Return the complete list of merged indices data."""
    ...
    return [
        ...
        ('Kaiko', 'Blue-Chip', 'Kaiko 5 Index', 'KT5', 'Real-time (5 sec), NYC, LDN, SGP', 'October 17, 2023', 'March 19, 2018', factsheet_blue_chip),
        ('Kaiko', 'Blue-Chip', 'Kaiko 10 Index', 'KT10', 'Real-time (5 sec), NYC, LDN, SGP', 'October 17, 2023', 'March 18, 2019', factsheet_blue_chip),
        ('Kaiko', 'Blue-Chip', 'Kaiko 15 Index', 'KT15', 'Real-time (5 sec), NYC, LDN, SGP', 'October 17, 2023', 'December 23, 2019', factsheet_blue_chip),
        ...
        # Sector & Thematic Indices (merged)
        ('Kaiko', 'Sector & Thematic', 'Kaiko Tokenization Index', 'KSTKNZ', 'Real-time (5 sec), NYC, LDN, SGP', 'January 23, 2025', 'January 3, 2022', factsheet_sector_thematic),
        ('Kaiko', 'Sector & Thematic', 'Kaiko AI Index', 'KSAI', 'Real-time (5 sec), NYC, LDN, SGP', 'January 23, 2025', 'October 3, 2022', factsheet_sector_thematic),
        ('Kaiko', 'Sector & Thematic', 'Kaiko Meme Index', 'KSMEME', 'Real-time (5 sec), NYC, LDN, SGP', 'January 22, 2025', 'April 3, 2023', factsheet_sector_thematic),
        ('Kaiko', 'Sector & Thematic', 'Kaiko DeFi Index', 'KSDEFI', 'Real-time (5 sec), NYC, LDN, SGP', 'January 17, 2025', 'April 3, 2023', factsheet_sector_thematic),
        ('Kaiko', 'Sector & Thematic', 'Kaiko L2 Index', 'KSL2', 'Real-time (5 sec), NYC, LDN, SGP', 'July 2, 2024', 'April 3, 2023', factsheet_sector_thematic),
        ...
        # Market Indices (merged)
        ('Kaiko', 'Market', 'Kaiko Standard Index', 'KMSTA', 'Real-time (5 sec), NYC, LDN, SGP', 'January 23, 2025', 'April 1, 2014', factsheet_market),
        ('Kaiko', 'Market', 'Kaiko Small Cap Index', 'KMSMA', 'Real-time (5 sec), NYC, LDN, SGP', 'January 23, 2025', 'January 2, 2015', factsheet_market),
        ('Kaiko', 'Market', 'Kaiko Mid Cap Index', 'KMMID', 'Real-time (5 sec), NYC, LDN, SGP', 'January 23, 2025', 'April 2, 2018', factsheet_market),
        ('Kaiko', 'Market', 'Kaiko Large Cap Index', 'KMLAR', 'Real-time (5 sec), NYC, LDN, SGP', 'January 23, 2025', 'April 1, 2014', factsheet_market),
        ('Kaiko', 'Market', 'Kaiko Investable Index', 'KMINV', 'Real-time (5 sec), NYC, LDN, SGP', 'January 23, 2025', 'April 1, 2014', factsheet_market),
...
def create_csv():
    """Create the CSV files with indices data."""
    debug_print("Creating CSV files for Kaiko indices coverage")
    
    headers = [
        'Brand', 'Benchmark Family', 'Name', 'Ticker', 'Dissemination(s)', 'Launch Date', 'Inception Date', 'Factsheet'
    ]
    ...
    debug_print(f"Creating main CSV: {main_csv_path}")
    ...
    # Create filtered CSV with only entries that have factsheets
    filtered_data = [item for item in data if item[-1] and item[-1] != '-' and 'Coming Soon' not in item[-1]]
    
    filtered_csv_path = "Reference_Rates_With_Factsheets.csv"
    debug_print(f"Creating filtered CSV: {filtered_csv_path}")
    ...
    debug_print(f"✅ Created {len(data)} total entries")
    debug_print(f"✅ Created {len(filtered_data)} entries with factsheets")
    debug_print("Process complete")

# Main execution
if __name__ == "__main__":
    debug_print("Starting Kaiko indices coverage CSV generation")
